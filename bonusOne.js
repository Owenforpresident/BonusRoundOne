...
var RPC_URL = "http://localhost:5050/v3/f1b70935143f4b22b3c165d6bdfd3021";
var id = 1;
...
function executeBatch() {
    return __awaiter(this, void 0, void 0, function () {
        var currentBatch, currentResolvers, body, response, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, bun_1.default.fetch(RPC_URL, {
                            method: "POST",
                            headers: {
                ...
                case 2:
                    ...
                    results.forEach(function (result, index) {
                        var balance = BigInt(result.result);
...
function scheduleBatch() {
    if (!batchWindow) {
        ...
        batchWindow = new Promise(function (resolve) { return setTimeout(resolve, 10); });
